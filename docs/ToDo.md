...
- En los terminales que usamos para interactuar con la sesion remota quiero añadir algo donde podamos lanzar cualquiera de los scripts que están en "Scripts PowerShell", la dorma de seleccionarlo que sea mediante un popup.